...
AS $$
DECLARE
  project_url TEXT := 'https://jlbsxqbtrqksnfmfnqao.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpsYnN4cWJ0cnFrc25mbWZucWFvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMzMwMjIzNiwiZXhwIjoyMDQ4ODc4MjM2fQ.G1CqxxcxeOYZhd6-GAJnOHM0sQTq805musNDSeGc8Yk'; -- full access needed for http request to storage
